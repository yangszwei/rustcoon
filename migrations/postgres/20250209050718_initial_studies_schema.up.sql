...
SELECT
    -- Study columns
    studies.*,
    -- Modalities in the study as an array
    ARRAY_AGG(DISTINCT series.modality)                               AS modalities_in_study,
...
FROM studies
         LEFT JOIN study_series series ON series.study_instance_uid = studies.study_instance_uid
